...
ADD INDEX fk_title_content (article_title, article_content(100));
...
CREATE TABLE `tb_blog_info`  (
  `id` int(11) NOT NULL,
  `about_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '关于我内容',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_user_info`  (
  ...
  `user_role` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user' COMMENT '用户角色',
